...
const COUNTRY_CURRENCY: Record<string, CurrencyCode> = {
  한국: "KRW", 대한민국: "KRW", 일본: "JPY", 중국: "CNY", 홍콩: "HKD",
  마카오: "MOP", 대만: "TWD", 미국: "USD", 괌: "USD", 사이판: "USD",
  태국: "THB", 베트남: "VND", 필리핀: "PHP", 싱가포르: "SGD",
  말레이시아: "MYR", 인도네시아: "IDR", 호주: "AUD", 뉴질랜드: "NZD",
  캐나다: "CAD", 멕시코: "MXN", 영국: "GBP", 프랑스: "EUR", 독일: "EUR",
  이탈리아: "EUR", 스페인: "EUR", 네덜란드: "EUR", 오스트리아: "EUR",
  벨기에: "EUR", 포르투갈: "EUR", 핀란드: "EUR", 아일랜드: "EUR",
  크로아티아: "EUR", 덴마크: "DKK", 스위스: "CHF", 폴란드: "PLN",
  체코: "CZK", 헝가리: "HUF", 터키: "TRY", 아랍에미리트: "AED",
  카타르: "QAR", 인도: "INR", 네팔: "NPR", 스리랑카: "LKR",
  캄보디아: "KHR", 라오스: "LAK", 미얀마: "MMK", 몽골: "MNT",
  카자흐스탄: "KZT", 우즈베키스탄: "UZS", 키르기스스탄: "KGS",
  투르크메니스탄: "TMT", 이스라엘: "ILS", 에티오피아: "ETB", 브루나이: "BND",
};

/** Destination catalog values are canonical; unknown free text safely uses USD. */
export function countryToCurrency(country: string): CurrencyCode {
  ...
  if (/프랑스|독일|이탈리아|스페인|네덜란드|오스트리아|벨기에|포르투갈|핀란드|아일랜드|크로아티아|france|germany|italy|spain|netherlands|austria|belgium|portugal|finland|ireland|croatia/i.test(key)) return "EUR";
