...
export const DEMO_TRENDING_CITIES: TrendingCity[] = [
  ...
  },
  {
    ...
    city: "방콕",
    country: "태국",
    reason: "짜뚜짝 주말시장과 아이콘시암 쇼핑",
    season: "가성비 여행",
    imageSrc: "/trip-backgrounds/thailand.jpg",
    tone: "bg-[#30333C]",
  },
  {
    id: "city-cebu",
    city: "세부",
    country: "필리핀",
    reason: "리조트 휴양과 아얄라몰 쇼핑",
    season: "가족 휴양",
    imageSrc: "/trip-backgrounds/cebu.jpg",
    tone: "bg-[#586E75]",
  },
  {
    id: "city-kaohsiung",
    city: "가오슝",
    country: "대만",
    reason: "용호탑 구경과 리우허 야시장 쇼핑",
    season: "겨울 따뜻",
    imageSrc: "/trip-backgrounds/kaohsiung.jpg",
    tone: "bg-[#586365]",
  },
  {
    id: "city-newyork",
    city: "뉴욕",
    country: "미국",
    reason: "타임스퀘어 야경과 5번가 쇼핑",
    season: "연말 쇼핑",
    imageSrc: "/trip-backgrounds/newyork.jpg",
    tone: "bg-[#3A2D66]",
  },
  {
    id: "city-hongkong",
    city: "홍콩",
    country: "홍콩",
    reason: "빅토리아 피크와 하버시티 쇼핑",
    season: "미식 쇼핑",
    imageSrc: "/trip-backgrounds/hongkong.jpg",
    tone: "bg-[#2D3A4B]",
  },
  {
    id: "city-danang",
    city: "다낭",
    country: "베트남",
    reason: "바나힐 골든브릿지와 한시장 쇼핑",
    season: "커플 여행",
    imageSrc: "/trip-backgrounds/danang.jpg",
    tone: "bg-[#355951]",
  },
];
